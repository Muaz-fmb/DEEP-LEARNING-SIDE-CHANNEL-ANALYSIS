...
if __name__ == "__main__":
	if len(sys.argv)!=2:
		...
		model_file="ATMEGA_AES_v1/ATM_AES_v1_fixed_key/ASCAD_data/ASCAD_trained_models/my_cnn_best_desync0_epochs75_batchsize50.h5"
		ascad_database=traces_file="ATMEGA_AES_v1/ATM_AES_v1_fixed_key/ASCAD_data/ASCAD_databases/ASCAD.h5"
		num_traces=2000
		target_byte=2
		multilabel=0
		simulated_key=0
		save_file = "test_plot_epoch75_batch50.png"
	else:
